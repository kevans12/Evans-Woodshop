angular.module('woodshop').service('mainService', function(){
    ...
    this.pinInfo = [{
        ...
        desc: 'These french style rolling pins measure approximately 20-22 inches long and are 2 inches in diameter, tapering at the ends with decorative beads carved in. They make the perfect addition to any kitchen.',
        id: 1,
        price: 49
        ...
        desc: 'These column style rolling pins measure approximately 20-22 inches long and are 2 inches in diameter throughout. They make the perfect addition to any kitchen. ',
        id: 2,
        price: 49
    },{
        ...
        desc: 'This big roller rolling pin measures approximately 21.5 inches long and is 3 inches in diameter in the center portion. It makes the perfect addition to any kitchen.',
        id: 5,
        price: 60
